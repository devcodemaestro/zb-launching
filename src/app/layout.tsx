...
export default function RootLayout({
  ...
  return (
    <html lang="ko">
      <body
        className={`${pretendard.variable} antialiased max-w-[390px] h-screen mx-auto overflow-hidden box-border break-keep px-6 min-h-screen font-[family-name:var(--font-pretendard)]`}
      >
        <Header />
        {children}
        <Footer />
